...
public class BookingController {
    ...
    public BookingDto update(@RequestHeader(value = "X-Sharer-User-Id") Long bookerId,
                             @PathVariable(value = "bookingId") Long bookingId,
                             @RequestParam(value = "approved") Boolean approved) {
        log.info("Started updating booking");
        final BookingDto bookingDto = bookingService.update(bookingId, bookerId, approved);
